...
void hist_2d_prod()
{
  ...
  TH2F *hxQ2_1 = new TH2F("hxQ2","distribution of x_{Bj} and Q^{2} mode : QE",80,0.1,2,80,0,3.5);
  TH2F *hxQ2_2 = new TH2F("hxQ2","distribution of x_{Bj} and Q^{2} mode : RES",80,0.1,2,80,0,3.5);
  TH2F *hxQ2_3 = new TH2F("hxQ2","distribution of x_{Bj} and Q^{2} mode : DIS",80,0.1,2,80,0,3.5);
  TH2F *hxQ2_4 = new TH2F("hxQ2","distribution of x_{Bj} and Q^{2} mode : 2p2h",80,0.1,2,80,0,3.5);

...
void hist_nuSTORM_musig_GiBUU_v3_arg(TString E3_fn, TString E4_fn, TString E5_fn, TString E6_fn, TString E7_fn, string root_file_path)
{
  ...
  /*
  TString fn_lst[] = {"E3SpectraMuSig560Nue_outAna7_MINERvALE_GiBUU_test_GFSPIZEROa7nuC_Filelist_GiBUUMINERvALE_nu_T0_Carbon_imitate.root", "E4SpectraMuSig566Nue_outAna7_MINERvALE_GiBUU_test_GFSPIZEROa7nuC_Filelist_GiBUUMINERvALE_nu_T0_Carbon_imitate.root", 
    "E5SpectraMuSig558Nue_outAna7_MINERvALE_GiBUU_test_GFSPIZEROa7nuC_Filelist_GiBUUMINERvALE_nu_T0_Carbon_imitate.root", "E6spectraMuSig557Nue_outAna7_MINERvALE_GiBUU_test_GFSPIZEROa7nuC_Filelist_GiBUUMINERvALE_nu_T0_Carbon_imitate.root", "E7SpectraMuSig556Nue_outAna7_MINERvALE_GiBUU_test_GFSPIZEROa7nuC_Filelist_GiBUUMINERvALE_nu_T0_Carbon_imitate.root"};
  int anaid{2};
  int noff{1};
  auto anatag{"outana7"};
 ...
 */
  ...
  if(fn_lst[0].Contains("outAna7")){
    ...
    pdf_out_name = "plot_nue_outana7.pdf";
  }
    ...
    pdf_out_name = "plot_nue_outana9.pdf";
...
int main(int argc, char* argv[])
{
  ...
  if(argc==7){
    hist_nuSTORM_musig_GiBUU_v3_arg(argv[1], argv[2], argv[3], argv[4], argv[5], argv[6]);
  }
  else{
    printf("wrong argc %d\n", argc); return 1;
  }

...
void hist_nuSTORM_musig_GiBUU_v3()
{
  /*
  TString fn_lst[] = {"E3SpectraMuSig560Numu_outAna9_MINERvALE_GiBUU_test_GFS0PIa9nuC_Filelist_GiBUUMINERvALE_nu_T0_Carbon_imitate.root", "E4SpectraMuSig566Numu_outAna9_MINERvALE_GiBUU_test_GFS0PIa9nuC_Filelist_GiBUUMINERvALE_nu_T0_Carbon_imitate.root",
    "E5SpectraMuSig558Numu_outAna9_MINERvALE_GiBUU_test_GFS0PIa9nuC_Filelist_GiBUUMINERvALE_nu_T0_Carbon_imitate.root", "E6spectraMuSig557Numu_outAna9_MINERvALE_GiBUU_test_GFS0PIa9nuC_Filelist_GiBUUMINERvALE_nu_T0_Carbon_imitate.root", "E7SpectraMuSig556Numu_outAna9_MINERvALE_GiBUU_test_GFS0PIa9nuC_Filelist_GiBUUMINERvALE_nu_T0_Carbon_imitate.root"};
  int anaid{1};
  int noff{2};
  auto anatag{"outana9"};
  ...
  Double_t hh1d_mom_hist_lower_bound[] = {0,0,0,0,0,0.4,0,0,0,0,0,0};
  Double_t hh1d_mom_hist_upper_bound[] = {180,6,180,3.5,180,1.3,180,5.5,1.7,1.6,180,180};
  */
  TString fn_lst[] = {"E3SpectraMuSig560Numu_outAna7_MINERvALE_GiBUU_test_GFSPIZEROa7nuC_Filelist_GiBUUMINERvALE_nu_T0_Carbon_imitate.root", "E4SpectraMuSig566Numu_outAna7_MINERvALE_GiBUU_test_GFSPIZEROa7nuC_Filelist_GiBUUMINERvALE_nu_T0_Carbon_imitate.root", 
    "E5SpectraMuSig558Numu_outAna7_MINERvALE_GiBUU_test_GFSPIZEROa7nuC_Filelist_GiBUUMINERvALE_nu_T0_Carbon_imitate.root", "E6spectraMuSig557Numu_outAna7_MINERvALE_GiBUU_test_GFSPIZEROa7nuC_Filelist_GiBUUMINERvALE_nu_T0_Carbon_imitate.root", "E7SpectraMuSig556Numu_outAna7_MINERvALE_GiBUU_test_GFSPIZEROa7nuC_Filelist_GiBUUMINERvALE_nu_T0_Carbon_imitate.root"};
  int anaid{2};
  int noff{1};
  auto anatag{"outana7"};
  ...
  Double_t hh1d_hist_lower_bound[] = {0,0,0.5,0};
  Double_t hh1d_hist_upper_bound[] = {1.1,3,2.8,8};

  Double_t hh1d_mom_hist_lower_bound[] = {0,0,0,0,0,0.4,0,0.4,0,0,0,0};
  Double_t hh1d_mom_hist_upper_bound[] = {180,5.5,180,2.1,180,3.5,180,4,1.7,1.6,180,180};
  ...
  TH1D *hh1d_mom[n_E][hh1d_mom_var_num];//={hxQ2_E7_scattertheta, hxQ2_E7_scattermomentum,  hxQ2_E7_mesontheta, hxQ2_E7_mesonmomentum, 
  ...
  for(int ii=0; ii<nh2d; ii++){
    ...
    c1->Print("plot.pdf",hh2d[ii/hh2d_var_num][ii%hh2d_var_num]->GetTitle());
  ...
  */
  ...
  int count_num{hh1d_mom_var_num}, stk_num{0};
  ...
  string tit_lst[n_stk][5] = {{"x_{Bj}", "#frac{d#sigma}{dx_{Bj}} (cm^{2}/x_{Bj}/nucleon)", "x_{Bj} of diff E modes", "x_{Bj} of diff E modes", "x_{Bj} of diff E modes"},
    ...
    {"beamE(GeV)", "#frac{d#sigma}{dW}(cm^{2}/GeV/nucleon)", "beamE of diff E modes", "beamE of diff E modes", "beamE of diff E modes"},

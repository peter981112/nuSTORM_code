...
void hist_simp_plot_high_stat_no_data_scatter_outana9()
{

  TString fn0{"outAna9_MINERvALE_GiBUU_test_GFS0PIa9nuC_Filelist_GiBUUMINERvALE_nu_T0_Carbon.root"};
  TString fn1{"outAna9_MINERvALE_GiBUU_test_GFS0PIa9nuC_Filelist_GiBUUMINERvALE_nu_T0_Carbon_1.root"};
  TString fn2{"outAna9_MINERvALE_GiBUU_test_GFS0PIa9nuC_Filelist_GiBUUMINERvALE_nu_T0_Carbon_2.root"};
  TString fn3{"outAna9_MINERvALE_GiBUU_test_GFS0PIa9nuC_Filelist_GiBUUMINERvALE_nu_T0_Carbon_3.root"};
  int anaid{1};
  int noff{2};
  auto anatag{"outana9"};
  ...
  */
  ...
  Double_t Q2, mesonmomentum, perweight, scattertheta, scattermomentum;//recoiltheta, recoilmomentum;//
  Int_t prod,evtMode;
  ...
  TString var = "scattertheta";
  TString var_2d = "scattermomentum";
...
/*
  ...
  */
  Double_t hh_lower_bound[] = {0,0,0}; //lower bound of 1d, 2dx, 2dy
  Double_t hh_upper_bound[] = {30,30,6}; //upper bound of 1d, 2dx, 2dy
  ...
  for (Int_t i=0; i<nentries; i++)
  {
    ...
    else
    {
      ...
      */
      ...
      {
        kk = 0;
        hh2d[kk]->Fill(scattertheta, scattermomentum,perweight);
        hh1d[kk]->Fill(scattertheta,perweight);        
        h_all_2d->Fill(scattertheta, scattermomentum,perweight);
      }
